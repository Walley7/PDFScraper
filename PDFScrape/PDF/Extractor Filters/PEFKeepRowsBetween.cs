...
namespace PDFScrape.PDF.Extractor_Filters {
    ...
    public class PEFKeepRowsBetween : PDFExtractorFilter {
        //================================================================================
        ...
        //================================================================================
        //--------------------------------------------------------------------------------
        public PEFKeepRowsBetween() : base() { }
        ...
        // TYPE ================================================================================
        //--------------------------------------------------------------------------------
        public override string TypeName { get { return "Keep Rows Between"; } }
        

        // SETTINGS ================================================================================
        //--------------------------------------------------------------------------------
        [APDFFilterSetting(Display = "Start condition", LabelInFront = false, Control = APDFFilterSetting.ControlType.BOOLEAN)]
        ...
        //--------------------------------------------------------------------------------
        [APDFFilterSetting(Display = "Include start row", LabelInFront = false, Padding = 8, Control = APDFFilterSetting.ControlType.BOOLEAN)]
        ...
        //--------------------------------------------------------------------------------
        [APDFFilterSetting(Display = "Include end row", LabelInFront = false, Padding = 8, Control = APDFFilterSetting.ControlType.BOOLEAN)]
        ...
        public override void WriteJSON(JsonTextWriter writer) {
            ...
            writer.WritePropertyName("start_condition"); writer.WriteValue(StartCondition);
            ...
            writer.WritePropertyName("end_condition"); writer.WriteValue(EndCondition);
