...
namespace PDFScrape.PDF.Extractor_Filters {
    ...
    public class PEFKeepColumnRange : PDFColumnExtractorFilter {
        //================================================================================
        ...
        //================================================================================
        //--------------------------------------------------------------------------------
        public PEFKeepColumnRange() : base() { }
        ...
        public override ScrapeTable Apply(ScrapeTable table) {
            ...
            newTable.KeepColumns(columnStart, columnEnd);
            return newTable;
        }
        ...
        // TYPE ================================================================================
        //--------------------------------------------------------------------------------
        public override string TypeName { get { return "Keep Column Range"; } }
