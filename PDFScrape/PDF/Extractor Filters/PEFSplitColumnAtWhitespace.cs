...
namespace PDFScrape.PDF.Extractor_Filters {
    ...
    public class PEFSplitColumnAtWhitespace : PDFColumnExtractorFilter {
        //================================================================================
        ...
        //================================================================================
        //--------------------------------------------------------------------------------
        public PEFSplitColumnAtWhitespace() : base() { }
        ...
        public override ScrapeTable Apply(ScrapeTable table) {
            ...
            newTable.SplitColumnAtWhitespace(column, maxSplits, NewHeaderPrefix, options);
            return newTable;
        }
        ...
        // TYPE ================================================================================
        //--------------------------------------------------------------------------------
        public override string TypeName { get { return "Split Column At Whitespace"; } }
