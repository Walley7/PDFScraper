...
namespace PDFScrape.PDF.Extractor_Filters {
    ...
    public class PEFRemoveColumnRange : PDFColumnExtractorFilter {
        //================================================================================
        ...
        //================================================================================
        //--------------------------------------------------------------------------------
        public PEFRemoveColumnRange() : base() { }
        ...
        public override ScrapeTable Apply(ScrapeTable table) {
            ...
            newTable.RemoveColumns(columnStart, columnEnd);
            return newTable;
        }
        ...
        // TYPE ================================================================================
        //--------------------------------------------------------------------------------
        public override string TypeName { get { return "Remove Column Range"; } }
