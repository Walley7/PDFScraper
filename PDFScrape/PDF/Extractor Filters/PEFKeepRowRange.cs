...
namespace PDFScrape.PDF.Extractor_Filters {
    ...
    public class PEFKeepRowRange : PDFExtractorFilter {
        //================================================================================
        ...
        public override ScrapeTable Apply(ScrapeTable table) {
            ...
            newTable.KeepRows(rowStart, rowEnd);
            return newTable;
        }
        ...
        // TYPE ================================================================================
        //--------------------------------------------------------------------------------
        public override string TypeName { get { return "Keep Row Range"; } }
