...
namespace PDFScrape.PDF.Extractor_Filters {
    ...
    public class PEFKeepRowsWhere : PDFExtractorFilter {
        //================================================================================
        ...
        public override ScrapeTable Apply(ScrapeTable table) {
            ...
            newTable.KeepRowsWhere(mCondition, mConditionArgument, column);
            return newTable;
        }
        ...
        // TYPE ================================================================================
        //--------------------------------------------------------------------------------
        public override string TypeName { get { return "Keep Rows Where"; } }
