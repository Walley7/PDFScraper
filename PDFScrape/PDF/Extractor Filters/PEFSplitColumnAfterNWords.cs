...
namespace PDFScrape.PDF.Extractor_Filters {
    ...
    public class PEFSplitColumnAfterNWords : PDFColumnExtractorFilter {
        //================================================================================
        ...
        //================================================================================
        //--------------------------------------------------------------------------------
        public PEFSplitColumnAfterNWords() : base() { }
        ...
        public override ScrapeTable Apply(ScrapeTable table) {
            ...
            newTable.SplitColumnAfterNWords(column, N, maxSplits, NewHeaderPrefix, options);
            return newTable;
        }
        ...
        // TYPE ================================================================================
        //--------------------------------------------------------------------------------
        public override string TypeName { get { return "Split Column After # Words"; } }
